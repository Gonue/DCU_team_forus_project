      ...
      searchGroup(event) {
        ...
        for (let i = 0; i < len; i++) {
          if (
            ...
            this.addressBook[i].userGrade.includes(event.target.value) === false &&
            this.addressBook[i].userDepartment.includes(event.target.value) === false &&
            this.addressBook[i].userEmail.includes(event.target.value) === false &&
            this.addressBook[i].userPhoneNumber.includes(event.target.value) === false
          ) {
